...
export const WIZARD_STEPS: WizardStep[] = [
  {
    ...
    hint: 'Describe the pain point or gap in the current system. Be specific about what\'s broken or missing.',
    placeholder: 'e.g. Users can\'t download the monthly sales report from the dashboard...',
    suggestions: [
  ...
  },
  {
    ...
    hint: 'Identify the specific users or roles affected. You can select multiple.',
    type: 'choice',
    choices: [
      { label: 'Operations Team', icon: '🏢' },
      { label: 'Sales Team', icon: '💼' },
      { label: 'Finance', icon: '💰' },
      { label: 'Management', icon: '👔' },
      { label: 'End Customers', icon: '👤' },
      { label: 'Dev / Engineering', icon: '🛠' },
      { label: 'QA Team', icon: '🔍' },
  ...
  },
  {
    ...
    hint: 'Describe the desired behavior in plain language. What happens when users interact with this feature?',
    placeholder: 'e.g. Users should be able to click a Download button and receive a filtered report as CSV or PDF...',
    suggestions: [
  ...
  },
  {
    ...
    placeholder: 'e.g. When the user clicks Export, selects date range and format, then clicks Download...',
    suggestions: [
      'On button click',
      'On form submit',
      'On scheduled timer',
  ...
  },
  {
    ...
    suggestions: [
      'Downloadable file (CSV/PDF/Excel)',
  ...
  },
  {
    ...
    hint: 'Define success criteria — the specific, testable conditions that confirm the feature is complete.',
    placeholder: 'e.g. Given a user with report access, when they click Download and select last 30 days, then a valid CSV downloads within 5 seconds...',
    suggestions: [
      'Download completes in < 3 seconds',
      'Data matches source records',
      'Works on mobile devices',
      'Handles 10,000+ rows without crash',
      'Shows error on invalid input',
      'Passes UAT with 3 real users',
    ],
    type: 'textarea',
  },
];
...
export const TEMPLATES = [
  ...
  { id: 'bug' as const, label: 'Bug Fix', icon: '⚡' },
